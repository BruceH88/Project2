...
$(document).ready(function () {
  ...
  $("#user-name-cheese").val(sessionStorage.getItem("username"));
  // $(".created-at-moment").val() = `${moment($(".created-at-moment").val()).format(format)} at ${moment($(".created-at-moment").val()).format(hourmat)}`
});